    ...
    <div class="flex-wrapper">
        ...
        <div class="status-wrapper">
            {#await dataFetch then fetchedData}
                ...
                {:else}
                    <p class="large-text" bind:this={statusElem}>
                        i am available for Free consultation after <br> {fetchedData.availablity_date}.
                    </p>
                {/if}
            {/await}
            <a class="button large-text" bind:this={fullEmailLinkElem} href="mailto:contact@sakshirawal.com" target="_blank">contact@sakshirawal.com</a>
        </div>
