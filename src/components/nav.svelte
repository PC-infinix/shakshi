	...
	<div class="flex-wrapper">
		...
		<div class="wrapper" class:mobileActive>
			<ul class="nav-list">
				...
				<li class="mobile">
					<a href=" tel:+1234567890" target="_blank" in:mobileTransitionSwitcher={{ delay: 350 }}>Call Me</a>
				</li>
				<li bind:this={githubElem}>
					<a href="mailto:contact@sakshirawal.com" target="_blank" in:mobileTransitionSwitcher={{ delay: 400 }}>Email Me</a>
				</li>
				{/key}
			</ul>
		</div>
