			...
			<div class="flex-wrapper second">
				<h1 class = "title">
					<div class="title-mask">
						<div class="word" bind:this={titleWord1}>Sakshi</div>
					</div><br> 
					<div class="title-mask">
						<div class="word" bind:this={titleWord2}>Rawal</div>
					</div>
				</h1>
				<div class="occupation mask">
					<p class = "paragraph" bind:this={shortDetails}>
						2nd yaer law student at Alliance University  Anekal, Karnataka
					</p>
				</div>
